...
while True:
	...
	if img.getpixel((79,16)) in ifcolor:
		cutnum(img,(86,1,111,30),'PLAYER-middle.jpg')
		print u"PLAYER-当中是。。。。。"+str(getverify1('PLAYER-middle.jpg'))  #middlecard

	# print img.getpixel((134,16))
	if img.getpixel((134,16)) in ifcolor:
		cutnum(img,((138,0,167,31)),'PLAYER-right.jpg')
	...
	# print img.getpixel((62,26))
	if img.getpixel((62,26)) in ifcolor:
		cutnum(img,(69,1,92,32),'BANKER-middle.jpg')
		clr.print_blue_text(u"BANKER-当中是。。。。。"+str(getverify1('BANKER-middle.jpg')))  #middlecard

	# print img.getpixel((7,26))
	if img.getpixel((7,26)) in ifcolor:
		cutnum(img,((12,1,39,32)),'BANKER-left.jpg')
		clr.print_blue_text(u"BANKER-左边是。。。。。"+str(getverify1('BANKER-left.jpg')))  #leftcard

	# print img.getpixel((137,26))
	if img.getpixel((137,26)) in ifcolor:
