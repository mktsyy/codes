...
def main():
	...
	region = (112,30,144,54)

	cropImg = img.crop(region)

	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right7.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\rightA.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\rightK.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right4.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right2.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right3.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right5.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right6.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right8.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\right9.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\rightJ.jpg")
	...
	cropImg.save(os.getcwd()+"\\bankerrighttemp\\rightQ.jpg")
	...
	# ################以下完成      
	cutpic = os.listdir(os.getcwd()+"\\bankerrighttemp")
	# a=getImgHash("temp.jpg")#图片地址自行替换 
	comparelist = []
	secondcard = []
	lastlist = []
	for pic in cutpic:
		a=getImgHash(os.getcwd()+"\\bankerrighttemp\\"+pic)#图片地址自行替换 
